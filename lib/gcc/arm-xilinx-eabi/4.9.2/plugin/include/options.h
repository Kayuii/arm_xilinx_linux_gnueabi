...
enum opt_code
{
  ...
  OPT_ffeature_proxy = 602,                  /* -ffeature-proxy */
  ...
  OPT_flicense_me = 711,                     /* -flicense-me */
  ...
  OPT_mabi_ = 1070,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1071,             /* -mabort-on-noreturn */
  OPT_mapcs = 1072,                          /* -mapcs */
  OPT_mapcs_float = 1073,                    /* -mapcs-float */
  OPT_mapcs_frame = 1074,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1075,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1076,              /* -mapcs-stack-check */
  OPT_march_ = 1077,                         /* -march= */
  OPT_marm = 1078,                           /* -marm */
  OPT_mbig_endian = 1079,                    /* -mbig-endian */
  ...
  OPT_mcpu_ = 1082,                          /* -mcpu= */
  OPT_mfix_cortex_a9_volatile_hazards = 1083,/* -mfix-cortex-a9-volatile-hazards */
